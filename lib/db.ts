...
export interface Product {
  ...
  price: number
  original_price: number
  regular_price: number // تمت الإضافة: السعر العادي
  installation_price: number // تمت الإضافة: سعر التركيب
  image: string
  local_image_path?: string
  category: string
  brand: string
...
class Database {
        ...
        .insert([
          {
            ...
            price: productData.price,
            original_price: productData.original_price || null,
            regular_price: productData.regular_price || null, // تمت الإضافة
            installation_price: productData.installation_price || null, // تمت الإضافة
            image: productData.image || "/placeholder.svg?height=400&width=400",
            local_image_path: productData.local_image_path || null,
            category: productData.category,
            brand: productData.brand,
  ...
  async updateProduct(
    ...
    try {
      ...
      if (productData.price !== undefined) updateData.price = productData.price
      if (productData.original_price !== undefined) updateData.original_price = productData.original_price
      if (productData.regular_price !== undefined) updateData.regular_price = productData.regular_price // تمت الإضافة
      if (productData.installation_price !== undefined) updateData.installation_price = productData.installation_price // تمت الإضافة
      if (productData.image !== undefined) updateData.image = productData.image
      if (productData.local_image_path !== undefined) updateData.local_image_path = productData.local_image_path
      if (productData.category !== undefined) updateData.category = productData.category
      if (productData.brand !== undefined) updateData.brand = productData.brand
